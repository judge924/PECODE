# Re-synthesize politicians.ts with NATIONAL_ASSEMBLY_299 and local members

code = '''import type { Politician, RegionHierarchy } from '../types/politician';
...
with open(r"c:\Users\Heisenbug\Documents\poliorg\src\data\politicians.ts", "w", encoding="utf-8") as f:
    f.write(code)

print("Updated politicians.ts successfully!")
